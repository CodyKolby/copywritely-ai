...
2. **Personalizacja** – jeśli to możliwe, używaj imienia odbiorcy.
3. **Porównania i kontrasty** – pokaż różnicę między skutecznym a nieskutecznym podejściem.
4. **Pytanie vs. rozkaz** – jeden tytuł to pytanie, drugi – mocne stwierdzenie.
5. **Jasność i prostota** – tytuły muszą być zrozumiałe natychmiast.
6. **Bez pustych fraz** – unikaj banałów typu „Odkryj sekret…”.
