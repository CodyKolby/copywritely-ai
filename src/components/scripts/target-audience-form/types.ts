...
export const formSchema = z.object({
  ...
  competitors: z.array(z.string()).min(1, { message: "Proszę podać przynajmniej jednego konkurenta" }),
  ...
  pains: z.array(z.string()).min(1, { message: "Proszę podać przynajmniej jeden problem" }),
  desires: z.array(z.string()).min(1, { message: "Proszę podać przynajmniej jedno pragnienie" }),
  ...
  benefits: z.array(z.string()).min(1, { message: "Proszę podać przynajmniej jedną korzyść" }),
